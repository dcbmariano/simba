...
<form role="form" method="POST" action="update">
	...
	<div class="form-group">
    	...
    	<input type="text" name="organism_project" class="form-control" value="{{ $project->organism_project }}" placeholder="Name Organism">
	</div>
	<div class="form-group">
    	<label>NGS:</label><br/>
	...
	<div class="form-group">
    	<label>Library</label>
    	<input type="text" name="library_project" class="form-control" value="{{ $project->library_project }}" placeholder="Library">
	</div>
	<br/>
